...
def racetrack_test1() -> bool:
    ...
    assert racetrack_.get_square(5, 0) == common.Square.GRASS
    assert racetrack_.get_square(5, 6) == common.Square.END
    assert racetrack_.get_square(0, 6) == common.Square.TRACK

    assert racetrack_.get_square(-1, -1) == common.Square.GRASS
    assert racetrack_.get_square(6, 7) == common.Square.GRASS
    assert racetrack_.get_square(6, 6) == common.Square.END
    assert racetrack_.get_square(10, 6) == common.Square.END
    assert racetrack_.get_square(-1, 6) == common.Square.GRASS
